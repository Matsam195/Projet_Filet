...
class Maille:
    """Une maille de hauteur n, de largeur m, composée de papillons parfaits"""

    def __init__(self, hauteur, largeur):
        self.n = hauteur # n papillons pour la hauteur de la grille
        self.m = largeur # m papillons pour la largeur de la grille
        self.pap = []
