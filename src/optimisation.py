...
def optimisation(P1,P2,P3,P4, l, oldP1=0, i=0):
    ...
    Df = DGradE(P1, P2, P3, P4, l) # Jacobien du Gradient de E
    f = gradE(P1, P2, P3, P4, l) # Gradient de E
...
def Energie(P1, P2, P3, P4, l):
    ...
    """
    return((P1.distance(P2)**2 - l**2)**2 + (P1.distance(P3)**2 - l**2)**2 + (P1.distance(P4)**2 - l**2)**2)
