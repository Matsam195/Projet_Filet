...
class Papillon:
    """Un papillon est formé de 6 points nommés par leur 'position géographique'"""

    def __init__(self):
        """Création par défaut : création de six points, tous en (0,0,0)"""
        self.so = Point()
        self.no = Point()
        self.nm = Point()
        self.ne = Point()
    ...
    def ajouterPapillonInitColonne(self, p1, p2, angle):
        """Ajoute un papillon au-dessus du papillon 'self'.
            Les longueurs du papillon créé sont les mêmes que la distance
            entre p1 et p2.
            p1 : Point nord-ouest de self et sud-ouest du voisin
            p2 : Point nord-milieu de self et sud-milieu du voisin"""
    ...
    def ajouterPapillonHrzt(self, p3):
        """Ajoute un papillon à la droite du papillon 'self', si la configuration
            de la maille le permet.
            p3 : Point nord-milieu de self"""
        #print(p3.x)
        #print(p3.y)
